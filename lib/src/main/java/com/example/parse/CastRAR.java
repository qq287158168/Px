...
public class CastRAR {
    ...
    public static String compressToBase64(String input) {
        if (input == null)
            return "";
        String res = CastRAR._compress(input, 6, new CompressFunctionWrapper() {
            @Override
    ...
    public static String decompressFromBase64(String inputStr) {
        ...
        // input.charAt(index)); }
        return CastRAR._decompress(input.length, 32, new DecompressFunctionWrapper() {
            @Override
    ...
    public static String compressToUTF16(String input) {
        if (input == null)
            return "";
        return CastRAR._compress(input, 15, new CompressFunctionWrapper() {
            @Override
            public Character doFunc(int a) {
                return fc(a + 32);
            }
    ...
    public static String decompressFromUTF16(String compressedStr) {
        ...
        return CastRAR._decompress(compressed.length, 16384, new DecompressFunctionWrapper() {
            @Override
            public Character doFunc(int index) {
    ...
    public static String compressToEncodedURIComponent(String input) {
        if (input == null)
            return "";
        return CastRAR._compress(input, 6, new CompressFunctionWrapper() {
            @Override
            public Character doFunc(int a) {
    ...
    public static String compress(String uncompressed) {
        return CastRAR._compress(uncompressed, 16, new CompressFunctionWrapper() {
            @Override
            public Character doFunc(int a) {
                return fc(a);
            }
    ...
    public static String decompress(final String compressed) {
        ...
        if (compressed == "")
            return null;
        return CastRAR._decompress(compressed.length(), 32768, new DecompressFunctionWrapper() {
